...
<div class="container">
    ...
    <ol class="breadcrumb breadcrumb-chevron bg-body-tertiary rounded-3 mb-3">
        ...
        <li class="breadcrumb-item fs-5 active">OrangeMoney</li>
    </ol>
    ...
    <form method="POST" action="{{ route('paiement.processus') }}">
        ...
        <input type="hidden" name="method" value="orange_money">
        ...
        <div>
            <p> Composez sur votre telephone <span style="color: green">*144*4*6*{{ $formation->prix ?? $commande->total }}#</span> suivez lzs intructions pour recevoir votre code otp. </p>
        </div>
