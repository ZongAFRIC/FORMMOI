...
<div class="container">
    ...
    <ol class="breadcrumb breadcrumb-chevron bg-body-tertiary rounded-3 mb-3">
        ...
        <li class="breadcrumb-item fs-5 active">CorisMoney</li>
    </ol>
    ...
    <form method="POST" action="{{ route('paiement.processus') }}">
        ...
        <input type="hidden" name="method" value="coris_money">
        ...
        <div>
            <p> Composez sur votre telephone <span style="color: green">*****</span> pour </p>
        </div>
