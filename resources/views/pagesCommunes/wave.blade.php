...
<div class="container">
    ...
    <ol class="breadcrumb breadcrumb-chevron bg-body-tertiary rounded-3 mb-3">
        ...
        <li class="breadcrumb-item fs-5 active">Wave</li>
    </ol>
    ...
    <form method="POST" action="{{ route('paiement.processus') }}">
        ...
        <div>
            <p> Composez sur votre telephone <span style="color: green">*808#</span> pour </p>
        </div>
...
<script>
    document.getElementById('montant').addEventListener('input', function () {
        ...
        if (isNaN(montantSaisi) || montantSaisi != prixFormation) {
            validationMessage.textContent = "Le montant au prix de la formation.";
