            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card align-items-center mb-6">
                       <h3 class="align-items-center mb-4">  Bienvenue sur e-education !</h3>
                        
                       <h5 class="mb-4"> Ceci est une plateforme oeuvrant dans la formation en ligne.</h5>

                    </div>

                    <div class="alert alert-success card ">
                        <h4 class="align-items-center text-align-center">
                            Votre inscription est réussie. Votre compte doit être validé par un administrateur avant de pouvoir vous connecter.
                            <br>
                            <br>
                            <span class=" mt-4">Vous recevrez un email une fois que votre compte sera activé.</span>
                        </h4>
                    </div>

                    <a href="#" class="btn fs-4">Contacter un administrateur</a>
