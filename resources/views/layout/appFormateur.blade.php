                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @if (auth()->guard('formateur')->check())
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="font-medium text-base text-gray-800">{{ auth()->guard('formateur')->user()->nom }} {{ auth()->guard('formateur')->user()->prenom }}</div>
                                <div class="font-medium text-base text-gray-800">
                                    <img class="img-profile rounded-circle"
                                         src="{{ auth()->guard('formateur')->user()->image ? asset('storage/' . auth()->guard('formateur')->user()->image) : asset('img/default_profile.svg') }}">
                                </div>
                            </a>
                        @else
